...
function poweron(){
  ...
  if(document.getElementById("power-switch").checked == false){
      ...
      document.getElementById("am-value_1").style.display = "none";
      document.getElementById("am-value1").style.display = "none";
      document.getElementById("am-value1_1").style.display = "none";
      document.getElementById("am-value2").style.display = "none";
      document.getElementById("am-value2_1").style.display = "none";
...
function vxil_ckt_sim() {
  ...
  document.getElementById("am-value_1").style.display = "block";
  document.getElementById("am-value1").style.display = "none";
  document.getElementById("am-value1_1").style.display = "none";
  document.getElementById("am-value2").style.display = "none";
  document.getElementById("am-value2_1").style.display = "none";
  ...
  document.getElementById("am-value_1").value = "0";
  document.getElementById("am-value1").value = "";
  document.getElementById("am-value1_1").value = "";
  document.getElementById("am-value2").value = "";
  document.getElementById("am-value2_1").value = "";
...
function vxil_calc(){
    ...
    document.getElementById("am-value_1").value = vx_1.toPrecision(3);
    ...
    arr[3] = document.getElementById("am-value_1").value;
...
function vxrth_ckt_sim() {
  alert("Finding Norton Resistance and Dependent Voltage (Vx) across Resistance (R1)");
  document.getElementById("main_ckt").style.display = "none";
  ...
  document.getElementById("am-value1_1").style.display = "block";
  document.getElementById("am-value2").style.display = "none";
  document.getElementById("am-value2_1").style.display = "none";
  document.getElementById("am-value3").style.display = "none";
  document.getElementById("instance-5-text").style.display = "none";
  ...
  document.getElementById("am-value_1").value = "";
  document.getElementById("am-value1").value = "0";
  document.getElementById("am-value1_1").value = "0";
  document.getElementById("am-value2").value = "";
  document.getElementById("am-value2_1").value = "";
  document.getElementById("am-value3").value = "";
...
function vxrth_calc(){
    ...
    document.getElementById("am-value1").value = vx_2.toPrecision(3);
    // --------------------CALCULATION OF Idc FOR INSTANCE 2--------------------
    idc = ((parseFloat(vdc) + parseFloat(vx_2))/parseFloat(r3));
    // --------------------CALCULATION OF RN FOR INSTANCE 2--------------------
    rth = (parseFloat(vdc)/parseFloat(idc));

    document.getElementById("am-value1_1").value = rth.toPrecision(3);
    ...
    arr1[2] = document.getElementById("am-value1").value;
...
function vxvth_ckt_sim() {
  alert("Finding Norton short circuit current and Dependent Voltage (Vx) across Resistance (R1)");
  document.getElementById("main_ckt").style.display = "none";
  document.getElementById("rth_ckt").style.display = "none";
  ...
  document.getElementById("am-value2_1").value = "0";
  document.getElementById("am-value3").value = "";
  document.getElementById("am-value").style.display = "none";
  document.getElementById("am-value_1").style.display = "none";
  document.getElementById("am-value1").style.display = "none";
  ...
  document.getElementById("am-value2_1").style.display = "block";
  document.getElementById("am-value3").style.display = "none";
}


var vx_3,vs,r1,r2,r3,cc,vth,dd,ee;
var tabrowindex2 = 0;
var arr2 = [];
var table2;
var load3;
...
function vxvth_calc(){
    ...
    cc = (4 * (parseFloat(r1)*parseFloat(r3)));
    dd = (parseFloat(vs)*parseFloat(r1))
    ee = (parseFloat(dd)*(parseFloat(r2) + parseFloat(r3)));
    vx_3 = parseFloat(ee)/((parseFloat(r1)*parseFloat(r2))+(parseFloat(r2)*parseFloat(r3))+(parseFloat(cc)))
    document.getElementById("am-value2").value = vx_3.toPrecision(3);
    // --------------------CALCULATION OF IN FOR INSTANCE 3--------------------
    vth = ((parseFloat(vs) - parseFloat(vx_3))/parseFloat(r3));

    document.getElementById("am-value2_1").value = vth.toPrecision(3);
    document.getElementById("vth-value").value = vth.toPrecision(3);
    // --------------------TABLE CREATION--------------------
    table2 = document.getElementById("obs-table-3");
    arr2[0] = tabrowindex2 + 1;
    arr2[1] = document.getElementById("am-value2_1").value;
    arr2[2] = document.getElementById("am-value2").value;
...
function eqv_ckt_sim() {
  alert("Finding Load Current (IL) from Norton equivalent circuit");
  document.getElementById("main_ckt").style.display = "none";
  document.getElementById("instance-1-sim").style.display = "none";
  document.getElementById("instance-2-sim").style.display = "none";
  document.getElementById("instance-3-sim").style.display = "none";
...
function eqv_calc(){
    ...
    Il_eqv = ((parseFloat(vth)*parseFloat(rth))/(parseFloat(rth)+parseFloat(rl)));
