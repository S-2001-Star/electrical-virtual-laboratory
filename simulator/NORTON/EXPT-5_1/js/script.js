...
function vxrth_ckt_sim() {
  alert("Finding Norton Resistance");
  document.getElementById("main_ckt").style.display = "none";
...
function vxvth_ckt_sim() {
  alert("Finding Norton Short Circuit Current");
  document.getElementById("main_ckt").style.display = "none";
  document.getElementById("rth_ckt").style.display = "none";
...
function vxvth_calc(){
    ...
    vth = ((parseFloat(vs)*parseFloat(r2))/((parseFloat(r1)*parseFloat(r2))+(parseFloat(r2)*parseFloat(r3))+(parseFloat(r1)*parseFloat(r3))))
