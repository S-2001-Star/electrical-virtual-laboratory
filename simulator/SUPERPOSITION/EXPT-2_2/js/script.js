...
function st1_ckt_sim(){
  alert("Computation of branch current I from main circuit in presence of both voltage source vs1 & current source is1");
...
var columns;
    ...
    function I_calc(){
      if (document.getElementById("vs1-value").value == ""){
        alert("Enter the value of source voltage vs1")
      }
        ...
        vs1 = document.getElementById("vs1-value").value;
        is1 = document.getElementById("vs2-value").value;
        ...
        I = (((parseFloat(vs1)-(parseFloat(is1)*parseFloat(r2)))*parseFloat(r1)) - ((parseFloat(r1)+parseFloat(r2))*(parseFloat(is1)*parseFloat(r3))))/((parseFloat(r1)+parseFloat(r2))*((parseFloat(r1)+parseFloat(r3)+parseFloat(r4)))-(Math.pow(parseFloat(r1),2)));
...
function st2_ckt_sim(){
  alert("Computation of branch current I1, when source voltage Vs1 is short circuited and current source is1 is acting alone.");
...
var columns1;
    ...
    function I1_calc(){
      if (document.getElementById("vs1-value").value == ""){
        ...
        I1 = (-(parseFloat(is1)*parseFloat(r1)*parseFloat(r2)) - ((parseFloat(r1)+parseFloat(r2))*(parseFloat(is1)*parseFloat(r3))))/((parseFloat(r1)+parseFloat(r2))*(parseFloat(r1)+parseFloat(r3)+parseFloat(r4))-(Math.pow(parseFloat(r1),2))); 
...
function st3_ckt_sim(){
  alert("Computation of branch current I2, when current source is1 is open circuited and source voltage vs1 is acting alone.");
  document.getElementById("instance-2-sim").style.display = "none";
  document.getElementById("instance-3-sim").style.display = "none";
...
var columns2;
    ...
    function I2_calc(){
      if (document.getElementById("vs1-value").value == ""){
        ...
        I2 = (parseFloat(vs1)*parseFloat(r1))/((parseFloat(r1)+parseFloat(r2))*(parseFloat(r1)+parseFloat(r3)+parseFloat(r4))-Math.pow(parseFloat(r1),2));
