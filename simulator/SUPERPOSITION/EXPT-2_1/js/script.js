...
function st1_ckt_sim(){
  alert("Computation of branch current I from main circuit in presence of both source voltages vs1 & vs2");
...
var columns;
    ...
    function I_calc(){
      if (document.getElementById("vs1-value").value == ""){
        ...
        alert("Enter the value of source voltage vs2")
      }
        ...
        vs2 = document.getElementById("vs2-value").value;
        r4 = document.getElementById("r4-value").value;

        I = (parseFloat(vs1) - parseFloat(vs2))/(parseFloat(r4));
...
function st2_ckt_sim(){
  alert("Computation of branch current I1, when source voltage Vs1 is short circuited and source voltage vs2 is acting alone.");
...
var columns1;
    ...
    function I1_calc(){
      if (document.getElementById("vs1-value").value == ""){
        ...
        I1 = (-(parseFloat(vs2)))/(parseFloat(r4)); 
...
function st3_ckt_sim(){
  alert("Computation of branch current I2, when source voltage Vs2 is short circuited and source voltage vs1 is acting alone.");
  document.getElementById("instance-2-sim").style.display = "none";
  document.getElementById("instance-3-sim").style.display = "none";
...
var columns2;
    ...
    function I2_calc(){
      if (document.getElementById("vs1-value").value == ""){
        ...
        I2 = (parseFloat(vs1))/parseFloat(r4);
