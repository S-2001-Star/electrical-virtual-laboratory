...
//////////ques-2//////////////////
    ...
    document.getElementById("noans6").style.display = "block";
    document.getElementById("noans6").innerHTML = "Ans: Norton's theorem is a method for finding the equivalent resistance of a complex circuit. The purpose of Norton's theorem is to simplify the analysis of complex circuits by reducing them to a single equivalent resistance, making it easier to calculate the current and voltage in the circuit."
    document.getElementById("noans6").style.color = "green";

    //////////ques-7//////////////////

    document.getElementById("noans7").style.display = "block";
    document.getElementById("noans7").innerHTML = "Ans: Both Norton's theorem and Thevenin's theorem are methods for simplifying complex circuits, but they approach the problem from different perspectives. Norton's theorem finds the equivalent resistance of a circuit by reducing it to a single resistance, while Thevenin's theorem finds the equivalent voltage source and resistance of a circuit by reducing it to a single voltage and single resistance."
    document.getElementById("noans7").style.color = "green";
}